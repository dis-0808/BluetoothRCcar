...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_20_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {    63, 0x0061,  10,  11,  11,   1,  12,   0,   0, 0x00 },
    {   118, 0x0077,  16,  11,  11,   0,  16,   0,   0, 0x00 }
};
...
touchgfx::GeneratedFont& getFont_verdana_20_4bpp()
{
    static touchgfx::GeneratedFont verdana_20_4bpp(glyphs_verdana_20_4bpp, 3, 20, 20, 0, 0, 4, 0, 0, 0, unicodes_verdana_20_4bpp, kerning_verdana_20_4bpp, 63, 0, 0, 0);
